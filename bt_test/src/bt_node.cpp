...
{
public:
  CalculateNum(const std::string &name, const NodeConfiguration &config) : SyncActionNode(name, config)
  {
  }
...
{
public:
  PrintNum(const std::string &name, const NodeConfiguration &config) : SyncActionNode(name, config)
  {
  }
...
public:
  ...
  Action_A(const std::string &name, const NodeConfiguration &config, int arg1,
           double arg2, std::string arg3) : SyncActionNode(name, config), _arg1(arg1), _arg2(arg2), _arg3(arg3)
  {
  }
  static PortsList providedPorts()
  {
