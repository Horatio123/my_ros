// https://docs.ros2.org/latest/api/rclcpp_lifecycle/classrclcpp__lifecycle_1_1LifecyclePublisher.html
...
public:
  ...
  on_activate(const rclcpp_lifecycle::State & state)
  {
    ...
    //could also be called manually here.
    pub_->on_activate();
...
int main(int argc, char * argv[])
{
  ...
  auto node = std::make_shared<LifecycleTalker>("lifecycle_pb");
